...
public class Menu {
    ...
    public void start() {
        ...
        flightService.setTicketSercive(ticketSercive);
        ...
        while (true) {
            ...
            System.out.println("\n==========================================");
            System.out.println("      ABC  AIRLINE  SYSTEM");
            System.out.println("==========================================");
    ...
    private void adminMenu() {
        ...
        if (!password.equals("12345")) {
            try {
                throw new AuthentictionException("password is wrong your are not admin!!");
            } catch (AuthentictionException e) {
    ...
    private void flightMenu() {
        ...
        while (true) {
            ...
            System.out.println("6. refund list ");
            System.out.println("0. Back");
