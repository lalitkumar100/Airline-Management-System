...
/**
 * Represents a passenger's frequent-flyer loyalty account.
 * <p>
 * Tracks earned points and membership tier (Silver, Gold, or Diamond).
 * Points are updated when bookings are made or cancelled, based on seat class.
 */
