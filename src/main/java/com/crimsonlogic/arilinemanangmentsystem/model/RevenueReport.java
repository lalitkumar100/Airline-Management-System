...
/**
 * Financial summary report for a single flight.
 * <p>
 * Aggregates total booking revenue, total refund amount, and computed net revenue
 * (bookings minus refunds) for administrative and analytics use.
 */
